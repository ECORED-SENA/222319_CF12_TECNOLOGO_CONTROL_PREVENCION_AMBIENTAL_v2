...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p(data-aos="fade") A continuación, se presentan conceptos importantes que debe apropiar:

    .row.fondo-tema1.align-items-center.pt-3.pb-5.mb-4
      .col-lg-12.col-12.px-lg-5.px-4
        .row.align-items-center.justify-content-center

          h4.t-green(data-aos="fade") Manejo integral de residuos

          p.mb-5(data-aos="fade") Es el conjunto de actividades que se realizan desde la generación hasta la eliminación del residuo o desecho sólido. Comprende las actividades de separación en la fuente, presentación, recolección, transporte, almacenamiento, tratamiento y/o la eliminación de los residuos o desechos sólidos. (Decreto 1713, 2002, p.3) 
    ...
    h4.t-green(data-aos="fade") Gestión integral de residuos sólidos

    p.mb-4(data-aos="fade") Es el conjunto de operaciones y disposiciones encaminadas a dar a los residuos producidos el destino más adecuado desde el punto de vista ambiental, de acuerdo con sus características, volumen, procedencia, costos, tratamiento, posibilidades de recuperación, aprovechamiento, comercialización y disposición final. (Decreto 1713, 2002, p.3) 
